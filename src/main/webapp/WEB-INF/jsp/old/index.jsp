...
<head>
    ...
    <script src="../../../../resources/static/js/js.cookie.js"></script>
    <style>
        #myCarousel{
            margin-left: 2%;
            width: 60%;
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="../../../../resources/static/images/82839-106.jpg" alt="第一张">
        </div>
        <div class="item">
            <img src="../../../../resources/static/images/105905-106.jpg" alt="第二张">
        </div>
        <div class="item">
            <img src="../../../../resources/static/images/296494-106.jpg" alt="第三张">
        </div>
